...
var timelinechart,areachartDatetimeColors=getChartColorsArray("area_chart_datetime");
areachartDatetimeColors&&(timelinechart={
    series:[
        {
            data:[
                [13273596e5,30.95],
...
(
    ...
    areachartNegativeColors&&(options={
        series:[
            {
                name:"North",
                data:[
                    ...
                    },
                    {
                        x:2001,
                        y:334
                    },{x:2002,y:325},{x:2003,y:316},{x:2004,y:318},{x:2005,y:330},{x:2006,y:355},{x:2007,y:366},{x:2008,y:337},{x:2009,y:352},{x:2010,y:377},{x:2011,y:383},{x:2012,y:344},{x:2013,y:366},{x:2014,y:389},{x:2015,y:334}]},{name:"South",data:[{x:1996,y:162},{x:1997,y:90},{x:1998,y:50},{x:1999,y:77},{x:2e3,y:35},{x:2001,y:-45},{x:2002,y:-88},{x:2003,y:-120},{x:2004,y:-156},{x:2005,y:-123},{x:2006,y:-88},{x:2007,y:-66},{x:2008,y:-45},{x:2009,y:-29},{x:2010,y:-45},{x:2011,y:-88},{x:2012,y:-132},{x:2013,y:-146},{x:2014,y:-169},{x:2015,y:-184}
                ]
            }
        ],
        chart:{
...
var optionsYears,chartYears,areachartyearsColors=getChartColorsArray("area_chart-years");
areachartyearsColors&&(optionsYears={series:[
    {
        name:"commits",
        data:githubdata.series
    }
...
colors:areachartyearsColors,dataLabels:{enabled:!1},
stroke:{
    width:0,
    curve:"smooth"
},
...
(chartYears=new ApexCharts(document.querySelector("#area_chart-years"),optionsYears)).render());
var generateDayWiseTimeSeries=function(e,t,a){for(var r=0,o=[];r<t;){var s=e,i=Math.floor(Math.random()*(a.max-a.min+1))+a.min;
    o.push([s,i]),e+=864e5,r++}return o
},
areachartstackedColors=getChartColorsArray("area_chart_stacked");
areachartstackedColors&&(options={
    series:[
        {
            name:"South",
...
for(var ts1=13885344e5,ts2=13886208e5,ts3=13890528e5,dataSet=[[],[],[]],i=0;i<12;i++){
    ...
    dataSet[0].push(innerArr)}for(i=0;i<18;i++){
        innerArr=[ts2+=864e5,dataSeries[1][i].value];dataSet[1].push(innerArr)
    }
    for(i=0;i<12;i++){
        innerArr=[ts3+=864e5,dataSeries[0][i].value];dataSet[2].push(innerArr)
    }
    var options,
    chart,
    ...
    (areachartirregularColors=getChartColorsArray("area-missing-null-value"))&&(options={
        series:[
            {
                name:"Network",
                data:[
