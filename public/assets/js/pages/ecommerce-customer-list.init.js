...
xhttp.onload=function(){
    ...
    customerList.remove(
        "id",'<a href="javascript:void(0);" class="fw-medium link-primary">#VZ2101</a>'
    )
},
xhttp.open(
    "GET",
    "assets/json/customer-list.json"
    ),
    xhttp.send(),
    ...
    document.getElementById("showModal").addEventListener("show.bs.modal",function(e){
        ...
        function SearchData(){
            ...
            l=document.getElementById("datepicker-range").value,
            s=l.split(" to ")[0],o=l.split(" to ")[1];
            customerList.filter(function(e){
                ...
                a="all"==t||"all"==i||t==i,
                n=new Date(
                    e.values().date.slice(0,12))>=new Date(s)&&new Date(e.values().date.slice(0,12))<=new Date(o);
                    return a&&n||(a&&""==l?a:n&&""==l?n:void 0)
                }),
                customerList.update()
        }
        var count=11;
        addBtn.addEventListener("click",function(e){
            ...
            function isStatus(e){
                switch(e){
                    case"Active":return'<span class="badge badge-soft-success text-uppercase">'+e+"</span>";
                    case"Block":return'<span class="badge badge-soft-danger text-uppercase">'+e+"</span>"
                }
            }
            function ischeckboxcheck(){
                Array.from(document.getElementsByName("checkAll")).forEach(
                    function(e){
        ...
        Array.from(e).forEach(function(e){
            ...
            t==itemId&&(
                ...
                phoneField.value=e._values.phone,statusVal&&statusVal.destroy(),
                statusVal=new Choices(
                    statusField,
                    {searchEnabled:!1}),
...
function deleteMultiple(){
    ...
    for(i=0;i<t.length;i++)1==t[i].checked&&(
        e=t[i].parentNode.parentNode.parentNode.querySelector("td a").innerHTML,
        ids_array.push(e)
    );
