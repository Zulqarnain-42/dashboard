var str_dt=function(e){
    ...
    a=(
        ...
        [
            day+" "+month+","+year+" <small class='text-muted'>"+n+":"+a+" "+e+"</small>"
        ]
    },
    ...
    checkAll&&(checkAll.onclick=function(){
            ...
            e[t].checked?e[t].closest("tr").classList.add("table-active"):e[t].closest("tr").classList.remove("table-active")
        });
        var perPage=8,
        options={
            valueNames:[
...
xhttp.onload=function(){
    ...
    xhttp.open(
        "GET","assets/json/orders-list.init.json"
        ),
        xhttp.send(),
        ...
        document.getElementById("showModal").addEventListener("show.bs.modal",function(e){
            e.relatedTarget.classList.contains("edit-item-btn")?(document.getElementById("exampleModalLabel").innerHTML="Edit Order",
    ...
    function SearchData(){
        ...
        orderList.filter(
            function(e){
                ...
                l=new Date(e.values().date.slice(0,12))>=new Date(r)&&new Date(e.values().date.slice(0,12))<=new Date(o);
        ...
        addBtn.addEventListener("click",function(e){
            ""!==customerNameField.value&&""!==productNameField.value&&""!==dateField.value&&""!==amountField.value&&""!==paymentField.value&&(
                ...
                editBtn.addEventListener("click",function(e){
                    ...
                    var t=orderList.get({id:idField.value});
                    Array.from(t).forEach(function(e){
                        isid=(new DOMParser).parseFromString(e._values.id,"text/html"),
                        isid.body.firstElementChild.innerHTML==itemId&&e.values({
                ...
                function isStatus(e){
                    switch(e){
                        case"Delivered":return'<span class="badge badge-soft-success text-uppercase">'+e+"</span>";
                        case"Cancelled":return'<span class="badge badge-soft-danger text-uppercase">'+e+"</span>";
                        case"Inprogress":return'<span class="badge badge-soft-secondary text-uppercase">'+e+"</span>";
                        case"Pickups":return'<span class="badge badge-soft-info text-uppercase">'+e+"</span>";
                        case"Returns":return'<span class="badge badge-soft-primary text-uppercase">'+e+"</span>";
                        case"Pending":return'<span class="badge badge-soft-warning text-uppercase">'+e+"</span>"
                    }
                }
                ...
                function refreshCallbacks(){Array.from(removeBtns).forEach(function(e){
                    e.addEventListener("click",function(e){
                    ...
                    e.addEventListener("click",function(e){
                        ...
                        Array.from(e).forEach(function(e){
                            ...
                            t==itemId&&(
                                ...
                                productnameVal=new Choices(
                                    productNameField,{searchEnabled:!1}
                                    ),
