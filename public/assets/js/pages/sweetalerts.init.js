document.getElementById("sa-basic") && document.getElementById("sa-basic").addEventListener("click",
    function () {
        Swal.fire({
...
document.getElementById("sa-title") && document.getElementById("sa-title").addEventListener("click",
    function () {
        Swal.fire({
            title: "The Internet?",
...
document.getElementById("sa-success") && document.getElementById("sa-success").addEventListener("click",
    function () {
        Swal.fire({
            title: "Good job!",
...
document.getElementById("sa-error") && document.getElementById("sa-error").addEventListener("click",
    function () {
        Swal.fire({
            title: "Oops...",
...
document.getElementById("sa-longcontent") && document.getElementById("sa-longcontent").addEventListener("click",
    function () {
        Swal.fire({
    ...
    document.getElementById("sa-warning") && document.getElementById("sa-warning").addEventListener("click",
        function () {
            Swal.fire({
                title: "Are you sure?",
    ...
    document.getElementById("sa-params") && document.getElementById("sa-params").addEventListener("click",
        function () {
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this!",
    ...
    document.getElementById("sa-image") && document.getElementById("sa-image").addEventListener("click",
        function () {
            Swal.fire({
                title: "Sweet!",
    ...
    document.getElementById("sa-close") && document.getElementById("sa-close").addEventListener("click",
        function () {
            var t;
            Swal.fire({
    ...
    document.getElementById("custom-html-alert") && document.getElementById("custom-html-alert").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("sa-dialog-three-btn") && document.getElementById("sa-dialog-three-btn").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("sa-position") && document.getElementById("sa-position").addEventListener("click",
        function () {
            Swal.fire({
                position: "top-end",
                icon: "success",
    ...
    document.getElementById("custom-padding-width-alert") && document.getElementById("custom-padding-width-alert").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("ajax-alert") && document.getElementById("ajax-alert").addEventListener("click",
        function () {
            Swal.fire({
                ...
                preConfirm: function (n) {
                    return new Promise(function (t, e) {
                        setTimeout(function () { "taken@example.com" === n ? e("This email is already taken.") : t() }, 2e3)
                    })
                }, allowOutsideClick: !1
            }).then(function (t) {
                Swal.fire({
    ...
    document.getElementById("custom-sa-success") && document.getElementById("custom-sa-success").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("custom-sa-error") && document.getElementById("custom-sa-error").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("custom-sa-warning") && document.getElementById("custom-sa-warning").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("custom-sa-community") && document.getElementById("custom-sa-community").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("custom-sa-email-verify") && document.getElementById("custom-sa-email-verify").addEventListener("click",
        function () {
            Swal.fire({
    ...
    document.getElementById("custom-sa-notification") && document.getElementById("custom-sa-notification").addEventListener("click",
        function () {
            Swal.fire({
