<x-app-layout>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <button type="button" class="btn w-sm btn-danger" onclick="delroleajax()" id="delete-record">Yes, Delete It!</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @section('scripts')
        ...
        <script src="{{ URL::asset('assets/js/pages/datatables/roledatatable.js')}}"></script>
    @endsection
</x-app-layout>
