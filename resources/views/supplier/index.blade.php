            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="model-datatables" class="table table-bordered nowrap table-striped align-middle"
                        ...
                        <tbody>
                            @foreach ($collectionsupplier as $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                ...
                                                <a href="{{ route('brand.edit', $supplier->id) }}"
                                            ...
                                            <form action="{{ route('brand.destroy', $supplier->id) }}"
                                                method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                                <button type="submit"
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="firstname" id="firstname" value="{{ isset($slider) ? $slider->heading : old('firstname') }}" placeholder="Firstname" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="lastname">Lastname</label>
                                        <input type="text" class="form-control" name="lastname" id="lastname" value="{{ isset($slider) ? $slider->text : old('lastname') }}" placeholder="Lastname" required>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" value="" placeholder="demo@mail.com">
                                    </div>
                                    <div class="mb-3 col-md-4">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="region" id="region" value="" placeholder="Region">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        <label class="form-label" for="country">Country</label>
                                        <input type="text" class="form-control" name="country" id="country" value="{{ isset($slider) ? $slider->text2 : old('country') }}" placeholder="Enter Country" required>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label class="form-label" for="city">City</label>
                                        <input type="text" class="form-control" name="city" id="city" value="{{ isset($slider) ? $slider->slug : old('city') }}" placeholder="Enter City" required>
                                    </div>
                                    <div class="mb-3 col-md-4">
