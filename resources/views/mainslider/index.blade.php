                ...
                <div class="mt-3 mt-lg-0">
                    <form action="javascript:void(0);">
                        <div class="row g-3 mb-0 align-items-center">
                            <!--end col-->
                            <div class="col-auto">
                                <a href="{{ route('mainslider.create') }}" type="button" class="btn btn-soft-success shadow-none"><i
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="model-datatables" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($collectionmainslider as $slider)
                            <tr>
                                <td>01</td>
                                <td>{{ $slider->id }}</td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a class="dropdown-item remove-item-btn" type="button" data-bs-toggle="modal" href="#deleteRecordModal">
