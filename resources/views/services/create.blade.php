                    ...
                    <div class="col-md-11">
                        <div class="row">
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="text" class="form-control" name="productitem[]">
                            </div>
                            <div class="mb-3 col-md-3">
                                <label for="lblmodel">Model</label>
                                <input type="text" class="form-control" name="productmodel[]" style="text-transform:uppercase">
                            </div>
                            <div class="mb-3 col-md-3">
                                <label for="lblserialno">Serial No</label>
                                <input type="text" class="form-control" name="serialno[]" style="text-transform:uppercase">
                            </div>
                            <div class="mb-3 col-md-3">
