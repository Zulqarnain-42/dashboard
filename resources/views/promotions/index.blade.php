                ...
                <div class="mt-3 mt-lg-0">
                    <form action="javascript:void(0);">
                        <div class="mb-0 row g-3 align-items-center">
                            <div class="col-auto">
                                <a href="{{ route('promotions.create') }}" type="button" class="shadow-none btn btn-soft-success"><i
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="promotion-datatable" class="table align-middle table-bordered nowrap table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Code</th>
