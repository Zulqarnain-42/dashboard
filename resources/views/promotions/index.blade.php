                ...
                <div class="mt-3 mt-lg-0">
                    <form action="javascript:void(0);">
                        <div class="row g-3 mb-0 align-items-center">
                            <div class="col-auto">
                                <a href="{{ route('promotions.create') }}" type="button" class="btn btn-soft-success shadow-none"><i
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="promotion-datatable" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Code</th>
...
<script src="{{ URL::asset('assets/js/pages/datatables/promotiondatatable.js')}}"></script>
@endsection
</x-app-layout>
