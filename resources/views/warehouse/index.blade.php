            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="model-datatables" class="table table-bordered nowrap table-striped align-middle"
                        ...
                        <tbody>
                            @foreach ($collectionwarehouse as $warehouse)
                                <tr>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="warehouse" id="warehouse" value="{{ isset($slider) ? $slider->heading : old('warehouse') }}" placeholder="Enter Warehouse" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="address">Address</label>
                                        <input type="text" class="form-control" name="address" id="address" value="{{ isset($slider) ? $slider->text : old('address') }}" placeholder="Enter Address" required>
                                    </div>
                                    <div class="mb-3 col-md-4">
