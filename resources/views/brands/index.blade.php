                    ...
                    <div class="mt-3 mt-lg-0">
                        <form action="javascript:void(0);">
                            <div class="row g-3 mb-0 align-items-center">
                                <div class="col-auto">
                                    <a href="{{ route('brand.create') }}" type="button" class="btn btn-soft-success shadow-none"><i
                        ...
                        <table id="model-datatables" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $brand->id }}</td>
                                    <td>{{ $brand->title }}</td>
                                    <td><img src="{{ URL::asset('storage/images/brands/') }}{{ '/'.$brand->image }}" height="35px"></td>
                                    <td>
                                        @if ($brand->status == 1)
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a href="{{ route('brand.edit',$brand->id) }}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                <li>
